...
//' @export
// [[Rcpp::export]]
List mvar_midcast(arma::cube x_acf, arma::mat z, arma::vec delta, bool debug)
{
  ...
  int N = z.n_rows; 
  int T = z.n_cols;
  IntegerVector all_series = seq(1,N);
  IntegerVector all_indices = seq(1,T);
  
  
// HERE

  IntegerVector full_indices = all_indices[colSums(Im(z)==1)==0]
